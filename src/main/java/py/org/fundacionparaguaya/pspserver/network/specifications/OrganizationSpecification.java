...
public class OrganizationSpecification {
  ...
  public static Specification<OrganizationEntity> byFilter(Long applicationId,
      Long organizationId) {
    return new Specification<OrganizationEntity>() {

      @Override
      public Predicate toPredicate(Root<OrganizationEntity> root, CriteriaQuery<?> query,
          CriteriaBuilder cb) {
  ...
  public static Specification<OrganizationEntity> byLoggedUser(UserDetailsDTO userDetails, List<Long> subOrganizations) {
